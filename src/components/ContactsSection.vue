<template>
 <div
    class="mt-16 sm:mb-0 border rounded-lg shadow-lg flex flex-col items-center py-10 px-5 text-cyan-800 shadow-cyan-600 bg-gradient-to-r from-white/20 via-purple-200/40 to-blue-200/40 backdrop-blur-md"
  >
